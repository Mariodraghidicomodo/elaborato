...
final_df.drop('scryfall_uri', axis=1, inplace=True)
final_df.drop('image_uris', axis=1, inplace=True)
final_df.drop('set_uri', axis=1, inplace=True)
final_df.drop('set_search_uri', axis=1, inplace=True)
final_df.drop('scryfall_set_uri', axis=1, inplace=True)
final_df.drop('rulings_uri', axis=1, inplace=True)
final_df.drop('prints_search_uri', axis=1, inplace=True)
final_df.drop('card_back_id', axis=1, inplace=True)
final_df.drop('illustration_id', axis=1, inplace=True)
final_df.drop('related_uris', axis=1, inplace=True)
